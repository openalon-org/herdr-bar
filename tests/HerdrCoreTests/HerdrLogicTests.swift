...
struct DashboardNavTests {
    ...
    @Test func namedSessionHasAgentsWhenAnyRowExists() {
        ...
        let agents = [idleOnly, blocked, working]
        #expect(DashboardNav.hasAgents(in: agents, session: "work"))
        #expect(DashboardNav.hasAgents(in: agents, session: "default"))
        #expect(!DashboardNav.hasAgents(in: agents, session: "missing"))
        #expect(DashboardNav.hasAgents(in: [idleOnly], session: "work"))
        #expect(!DashboardNav.hasAgents(in: [], session: "work"))
    }
}
